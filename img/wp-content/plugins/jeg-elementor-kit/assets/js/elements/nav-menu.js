!(function (e) {
  ...
  function (e, n) {
    class t extends elementorModules.frontend.handlers.Base {
      getDefaultSettings() {
        return {
          selectors: {
            ...
            close_toggle:
              '.jkit-close-menu, .menu-item:not(.menu-item-has-children) a[href^="#"]',
      ...
      onLoadElement() {
        this.addBodyClass(), this.addDropdownIcon(), this.onToogleClick();
      }
      addBodyClass() {
      ...
      onToogleClick() {
        ...
        o.on("click", function (n) {
          ...
          r.on("click", function (n) {
            n.preventDefault(), e.elements.$container.removeClass("active");
          }),
