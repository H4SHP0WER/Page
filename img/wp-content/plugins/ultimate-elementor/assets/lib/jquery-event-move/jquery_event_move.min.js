...
!(function (e) {
    ...
    if (r)
      for (; m--; )
        if ((a = r[(i = t[m])]))
          for (c = a.length; c--; )
            a[c][0] === n &&
              (e.removeEventListener(i, a[c][1]), a.splice(c, 1));
  }
  function v(t, n, o) {
    var i = (function (e) {
  ...
  function Y() {
    f(document, i.move, h), f(document, i.cancel, X);
  }
  function y(e) {
  ...
  function E(e, t) {
    var n = t.target,
      o = t.event,
      i = t.timer;
    p(e.changedTouches, o.identifier) &&
      (!(function (e) {
  ...
  if (
    (m(document, "mousedown", function (e) {
      (function (e) {
        ...
        ((function (e) {
          ...
          (m(document, i.move, h, e), m(document, i.cancel, X, e)));
    }),
    ...
    m(document, "movestart", function (e) {
      if (!e.defaultPrevented && e.moveEnabled) {
        ...
        void 0 === e.identifier
          ? (m(e.target, "click", l),
            m(document, i.move, b, o),
            m(document, i.end, T, o))
          : ((o.activeTouchmove = function (e, t) {
            ...
            m(document, a.move, o.activeTouchmove, o),
            m(document, a.end, o.activeTouchend, o));
      }
    }),
    window.jQuery)
  ) {
